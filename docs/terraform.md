...
| <a name="input_assign_public_ip_on_launch"></a> [assign\_public\_ip\_on\_launch](#input\_assign\_public\_ip\_on\_launch) | Flag to enable/disable whether instances launched into public subnets should be assigned a public IP address | `bool` | `false` | no |
